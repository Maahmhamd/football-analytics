-- ===== قاعدة بيانات تحليل مباريات كرة القدم - نسخة محسّنة =====
-- Football Analytics Database - Fixed Version for MariaDB
-- هذه النسخة تعمل مع جميع إصدارات MySQL و MariaDB
...
-- تم الإنشاء بنجاح
-- Success Message: Database created successfully!
